...
// transactions can only be created by wallets
describe('Transaction', () => {
    ...
    describe('input', () => {
        ...
        it('sets the the `amount` to the `senderWallet` balance', () => {
    ...
    describe('update()', () => {
        // the update function has the ability to add a new amount for a new recipient in an existing transaction ouputMap
        ...
        describe('and the amount is valid', () => {
            ...
            describe('and another update for the same recipient', () => {
                ...
                it('substracts the amount from the original sender output amount', () => {
                    ...
                    // check the addedAmount is substracted from the remaining balance
                })
            })
        })
    })
